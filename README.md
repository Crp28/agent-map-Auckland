...
- Saving a Sold Property for an address currently owned by People removes that matching address row from those People, converts their Property link to `former_owner`, and records one `sell` interaction dated to the sold date.
